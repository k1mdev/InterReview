...
const Sidebar = () => {
  ...
  return (
    <div
      ...
      ${collapsed ? "w-20" : "w-[17vw]"} transition-all duration-300 bg-white`}
    >
      ...
      {!collapsed && (
        <div className="-0 p-4 border-b border-gray-200 bg-gray-50">
      ...
      {!collapsed && <div className="-0 w-full border-t border-black"></div>}
      ...
      {!collapsed && (
        <div className="-0 p-4 border-t border-black">
